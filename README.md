...
- 🖥️ Auto-detect OS: Ubuntu/Debian, Fedora/RHEL/CentOS/Rocky, Alpine, Arch
...
Atau non-interaktif (bisa untuk cron/ansible):
...
| 4 | Cloud9 jalan di `127.0.0.1:8000` dengan USERNAME/PASSWORD env |
| 5 | Nginx vhost: `https://domain` → `127.0.0.1:8000`, di depan basic auth |
...
- **Port 8000 sudah kepake** → ubah mapping `127.0.0.1:8000:8000` di compose (port host bagian kiri).
